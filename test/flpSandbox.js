		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Portifolio",
									"targetURL": "#myportifolioapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myportifolioapp-display": {
								"semanticObject": "myportifolioapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myportifolioapp",
									"url": sap.ui.require.toUrl("myportifolioapp")
								}
							}
						}
					}
